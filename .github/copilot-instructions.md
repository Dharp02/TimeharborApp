# Copilot Instructions for TimeharborApp
...
- **express-api**: Backend API server (TypeScript, Express, Sequelize)
- **timeharbourapp**: Frontend application (Next.js, React, Capacitor for mobile)
- **timeharbor-proxy**: Proxy server
- **ychart**: Chart component library

### Technology Stack
- **Frontend**: Next.js 14+, React, TypeScript, Tailwind CSS, Capacitor
