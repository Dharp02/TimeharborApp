...
const OpenTickets = dynamic(() => import('@/components/dashboard/OpenTickets'), {
  loading: () => <div className="h-64 bg-card rounded-2xl shadow-sm animate-pulse" />
});
...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-card border border-border mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-foreground">Timehuddle</span>
        </div>
        <span className="text-xs font-medium text-primary-500 border border-primary-500/50 rounded-full px-3 py-1">via Timehuddle</span>
      </div>
      <StoriesBar />
