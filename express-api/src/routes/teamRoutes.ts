...
import { createTeam, joinTeam, getMyTeams, updateTeam, deleteTeam, addMember, removeMember, getTeamActivity } from '../controllers/teamController';
...
router.get('/:id/activity', authenticateToken, getTeamActivity);
